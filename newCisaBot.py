...
'''
    ...
    def update_readme(self, new_items):
        ...
        for item in new_items:
            vulnerability_entry = f"- **{item['cveID']}**: ({item['vulnerabilityName']}) Vendor Project: {item.get('title', f'{item.get('vendorProject', 'Unknown Vendor')} Product: {item.get('product', 'Unknown Product')}')}"
